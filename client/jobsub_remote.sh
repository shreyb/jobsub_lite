...
curl --cert /tmp/x509up_u${UID} $CACERT -H "Accept: application/json" -X POST $file_upload -F jobsub_args_base64=$COMMAND https://$JOBSUB_HOST:8443/jobsub/accountinggroups/$ACCOUNTING_GROUP/jobs/ && echo
