...
class ArgParser(object):
	def __init__(self):
		...
		#print "val='%s'"%val
                allowed = ["e938","e875","mars","lbnemars","marsmu2e","marsgm2","larrand","nova","t-962","mu2e","microboone","lbne"]
...
class JobRunner(object):
	...
	def doSubmit(self,args=None):
		...
		if host == args.submitHost:
			cmd = """ . /opt/condor/condor.sh ; condor_submit_dag """
		else:
			cmd = """ssh %s ". /opt/condor/condor.sh ; condor_submit_dag """ % args.submitHost
