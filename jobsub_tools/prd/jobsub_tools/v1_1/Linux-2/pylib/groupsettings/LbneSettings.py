...
class LbneSettings(JobSettings):
    ...
    def initParser(self):
        #print "LbneSettings initParser"
        parser = self.parser
        self.lbne_group = OptionGroup(self.parser, "Lbne Specific Options")
        self.parser.add_option_group(self.lbne_group)
        ...
        self.lbne_group.add_option("-O", dest="msopt",
                                 action="store",type="string",
                                 help="optimize flag")
        return super(LbneSettings,self).initParser()
