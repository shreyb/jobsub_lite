...
##         return argshift
    ...
    def initParser(self):
        #print "MinosSettings initParser"
        parser = self.parser
        self.minos_group = OptionGroup(self.parser, "Minos Specific Options")
        self.parser.add_option_group(self.minos_group)

        #print "MinosSettings initParser parser=%s"%self.parser
        #print "MinosSettings initParser file_group=%s"%self.file_group
        #return
        ...
        self.minos_group.add_option("-O", dest="msopt",
                                 action="store",type="string",
                                 help="optimize flag")
        return super(MinosSettings,self).initParser()
